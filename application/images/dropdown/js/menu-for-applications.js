...
DHTMLSuite.config.prototype = {
	...
	init : function()
	{
		this.imagePath = baseUrl+'application/images/dropdown/images_dhtmlsuite/';	// Path to images		
		this.cssPath = baseUrl+'application/images/dropdown/css_dhtmlsuite/';;	// Path to images		
	}	
	// }}}
	,
	// {{{ setCssPath()
